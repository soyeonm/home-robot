...
@dataclass
class RobotNavActionConfig(ActionConfig):
    type: str = "RobotNavAction"
    # Whether the motion is in the form of base_velocity or human_joints
    motion_control: str = "base_velocity"
    num_joints: int = 17
    turn_velocity: float = 1.0
...
@dataclass
class HumanoidNavActionConfig(ActionConfig):
    type: str = "HumanoidNavAction"
    # Whether the motion is in the form of base_velocity or human_joints
    motion_control: str = "base_velocity"
    num_joints: int = 17
    turn_velocity: float = 1.0
...
cs.store(
    package="habitat.task.actions.humanoid_nav_action",
    group="habitat/task/actions",
    name="humanoid_nav_action",
    node=HumanoidNavActionConfig,
)
cs.store(
    package="habitat.task.actions.robot_nav_action",
    group="habitat/task/actions",
    name="robot_nav_action",
    node=RobotNavActionConfig,
)
cs.store(
